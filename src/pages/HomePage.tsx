                    ...
                    <div className="grid grid-cols-4 gap-6">
                        {categories.map((category) => (
                            ...
                            >
                                ...
                                <h3 className="text-lg font-bold group-hover:text-neutral-700 transition-colors">
                                    {category.name}
                                </h3>
                            </Link>
                        ))}
                ...
                <section className="mb-24">
                    <div className="flex justify-between items-center mb-12">
                        ...
                        <Link
                            ...
                            className="text-black hover:text-neutral-600 transition-colors font-semibold"
                        >
                            Wszystkie produkty →
                        </Link>
                    </div>
                    ...
                    <div className="grid grid-cols-3 gap-8">
                        <div className="bg-white rounded-xl p-8 shadow-sm">
                            ...
                            <p className="text-neutral-600">
                                Zaufaj nam - jesteśmy liderem w branży od ponad
                                30 lat
                            </p>
                        </div>
                        <div className="bg-white rounded-xl p-8 shadow-sm">
                            ...
                            <p className="text-neutral-600">
                                Ponad sto tysięcy zadowolonych klientów na całym
                                świecie
                            </p>
                        </div>
                        <div className="bg-white rounded-xl p-8 shadow-sm">
                            ...
                            <p className="text-neutral-600">
                                Nasz zespół zawsze gotowy do pomocy, 24 godziny
                                na dobę
                            </p>
                        </div>
                    </div>
