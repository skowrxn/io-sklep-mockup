      ...
      <nav className="bg-white border-b border-neutral-200">
        <div className="max-w-7xl mx-auto px-6">
          <ul className="flex gap-8 py-4">
            <li><a href="#" className="text-sm font-medium text-neutral-700 hover:text-black transition-colors">Nowości</a></li>
            <li><a href="#" className="text-sm font-semibold text-black">Bluzy</a></li>
            <li><a href="#" className="text-sm font-medium text-neutral-700 hover:text-black transition-colors">T-Shirty</a></li>
            <li><a href="#" className="text-sm font-medium text-neutral-700 hover:text-black transition-colors">Spodnie</a></li>
            <li><a href="#" className="text-sm font-medium text-neutral-700 hover:text-black transition-colors">Akcesoria</a></li>
            <li><a href="#" className="text-sm font-semibold text-red-600 hover:text-red-700 transition-colors">Sale</a></li>
          </ul>
        </div>
      </nav>
        ...
        <div className="flex gap-12">
          ...
          <aside className="w-64 flex-shrink-0">
            <div className="sticky top-8">
              <div className="flex justify-between items-center mb-6">
                <h2 className="text-lg font-bold tracking-tight">Filtry</h2>
                {hasActiveFilters && (
                  <button
              ...
              <div className="border-t border-neutral-200">
                ...
                >
                  <div className="space-y-3">
                    <div>
                      <label className="block text-xs font-medium text-neutral-700 mb-2">Od (PLN)</label>
                      <input
                        type="number"
                        value={minPrice}
                    ...
                    <div>
                      <label className="block text-xs font-medium text-neutral-700 mb-2">Do (PLN)</label>
                      <input
                        type="number"
                        value={maxPrice}
          ...
          <main className="flex-1">
            <div className="mb-10 flex justify-between items-end">
              <div>
                <h2 className="text-5xl font-bold tracking-tight mb-2">Bluzy</h2>
                <p className="text-sm font-medium text-neutral-500">{products.length} Produktów</p>
              </div>
              <div className="flex gap-3 items-center">
                <span className="text-xs font-medium text-neutral-600">Sortuj:</span>
              ...
              {products.map(product => (
                <div key={product.id} className="group">
                  ...
                  <div>
                    ...
                    <p className="text-xl font-bold mb-4">{product.price} PLN</p>
                    ...
                    <button className="w-full bg-black text-white py-3.5 text-sm font-semibold hover:bg-neutral-900 hover:shadow-md transition-all rounded-xl">
                      Szybki podgląd
                    </button>
                  </div>
                </div>
          ...
          <div className="grid grid-cols-4 gap-12 mb-12">
            <div>
              ...
              <ul className="space-y-2.5">
                <li><a href="#" className="text-sm text-neutral-600 hover:text-black transition-colors">Nowości</a></li>
                <li><a href="#" className="text-sm text-neutral-600 hover:text-black transition-colors">Bluzy</a></li>
                <li><a href="#" className="text-sm text-neutral-600 hover:text-black transition-colors">T-Shirty</a></li>
                <li><a href="#" className="text-sm text-neutral-600 hover:text-black transition-colors">Akcesoria</a></li>
              </ul>
            </div>
            <div>
